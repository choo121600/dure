...
export const LIMITS: LimitsConfig = {
  ...
  MAX_BRIEFING_LENGTH: parseEnvInt(process.env.DURE_MAX_BRIEFING_LENGTH, 100000),

  /** Maximum output history lines to capture */
  MAX_OUTPUT_HISTORY_LINES: parseEnvInt(process.env.DURE_MAX_OUTPUT_HISTORY_LINES, 200),

  /** Maximum pane capture lines */
  MAX_PANE_CAPTURE_LINES: parseEnvInt(process.env.DURE_MAX_PANE_CAPTURE_LINES, 100),

  /** Maximum pane capture lines limit */
  MAX_PANE_CAPTURE_LIMIT: parseEnvInt(process.env.DURE_MAX_PANE_CAPTURE_LIMIT, 10000),

  /** Maximum path length */
  MAX_PATH_LENGTH: parseEnvInt(process.env.DURE_MAX_PATH_LENGTH, 4096),

  /** Maximum text field length */
  MAX_TEXT_FIELD_LENGTH: parseEnvInt(process.env.DURE_MAX_TEXT_FIELD_LENGTH, 10000),

  /** Maximum decision text length */
  MAX_DECISION_LENGTH: parseEnvInt(process.env.DURE_MAX_DECISION_LENGTH, 1000),

  /** Maximum file size in lines for builder */
  MAX_FILE_SIZE_LINES: parseEnvInt(process.env.DURE_MAX_FILE_SIZE_LINES, 500),

  /** Maximum iterations allowed */
  MAX_ITERATIONS: parseEnvInt(process.env.DURE_MAX_ITERATIONS, 100),

  /** Minimum iterations allowed */
  MIN_ITERATIONS: parseEnvInt(process.env.DURE_MIN_ITERATIONS, 1),

  /** Maximum buffer size for command output (1MB) */
  MAX_COMMAND_BUFFER: parseEnvInt(process.env.DURE_MAX_COMMAND_BUFFER, 1024 * 1024),

  /** Maximum recent events to track in file watcher */
  MAX_RECENT_EVENTS: parseEnvInt(process.env.DURE_MAX_RECENT_EVENTS, 100),
} as const;
