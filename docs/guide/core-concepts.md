...
Orchestral을 효과적으로 사용하기 위해 이해해야 할 핵심 개념들을 설명합니다.

## 설계 원칙

Orchestral은 다음 원칙에 따라 설계되었습니다:
...
이 정보는 `.orchestral/runs/{run_id}/` 에 영구 저장됩니다.
...
```bash
# 과거 run 재현
orchestral replay run-20240126-143022
```
